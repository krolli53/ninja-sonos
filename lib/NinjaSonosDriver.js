...
var DOORBELL_MP3_URL = "https://iris.fhict.nl/~i872953/speech/two_tone_doorbell.mp3";
var DOGS_MP3_URL = "https://iris.fhict.nl/~i872953/speech/barking_dogs.mp3";
...
NinjaSonosDriver.prototype.write = function(data){
  ...
  switch(data){
      ...
      case "stopped":
        ...
        break;
      case "doorbell":
        self._client.play(DOORBELL_MP3_URL,function(err,playing){
          if(err)
            this.writeError(err);
          else {
        ...
        break;
      case "dogs":
        self._client.play(DOGS_MP3_URL,function(err,playing){
          if(err)
            this.writeError(err);
          else {
